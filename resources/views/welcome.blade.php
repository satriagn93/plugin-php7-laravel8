...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div style="margin-bottom: 30px;" class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <form id="" method="POST" action="{{ route('sendmail') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="p-6">
                            <div class="flex items-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.niagahoster.co.id/blog/cara-kirim-email-laravel/" class="underline text-gray-900 dark:text-white">Sent Email with SMTP</a></div>
                            </div>
                            <div class="ml-12"><br>
                                <div style="margin-bottom: 10px;" class="input-group">
                                    <span style="width: 80px;" class="input-group-text">Email</span>
                                    <input name="email" type="text" aria-label="First name" class="form-control">
                                </div>
                                <div class="input-group">
                                    <span style="width: 80px;" class="input-group-text">Message</span>
                                    <input name="message" type="text" aria-label="First name" class="form-control">
                                </div>
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <button type="submit" class="button button1"> Sent</button>
                                </div>
                            </div>
                        </div>
                    </form>
